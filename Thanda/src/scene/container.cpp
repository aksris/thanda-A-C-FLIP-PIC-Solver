...
Container::Container() {
	...
	gl_positions.push_back(glm::vec3(-0.5f, -0.5f, -0.5f));
	gl_positions.push_back(glm::vec3(-0.5f, -0.5f, 0.5f));
	gl_positions.push_back(glm::vec3(-0.5f, 0.5f, 0.5f));
	gl_positions.push_back(glm::vec3(-0.5f, 0.5f, -0.5f));
	gl_positions.push_back(glm::vec3(0.5f, -0.5f, -0.5f));
	...
	gl_indices.push_back(0);
	gl_indices.push_back(4);
	gl_indices.push_back(1);
	gl_indices.push_back(5);
	gl_indices.push_back(2);
	gl_indices.push_back(6);
	gl_indices.push_back(3);
	gl_indices.push_back(7);
	...
	glBufferData(GL_ARRAY_BUFFER, sizeof(glm::vec3) * gl_positions.size(), &gl_positions[0], GL_STATIC_DRAW);


	glGenBuffers(1, &elementBuffer);
	glBindBuffer(GL_ELEMENT_ARRAY_BUFFER, elementBuffer);
	glBufferData(GL_ELEMENT_ARRAY_BUFFER, gl_indices.size() * sizeof(GLuint), &gl_indices[0], GL_STATIC_DRAW);

	modelMatrix = glm::mat4(); // defaults to identity matrix
}
...
bool Container::collisionDetect(Particle *p, float dt, glm::vec3 &coll_Pos, glm::vec3 &coll_Nor) {
