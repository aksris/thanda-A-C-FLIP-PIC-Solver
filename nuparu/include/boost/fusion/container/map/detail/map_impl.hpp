...
namespace boost { namespace fusion { namespace detail
{
    ...
    struct map_impl<index_, Pair, T...> : map_impl<index_ + 1, T...>
    {
        ...
        map_impl(map_impl&& rhs)
          : rest_type(boost::forward<rest_type>(*static_cast<rest_type*>(this)))
          , element(boost::forward<Pair>(rhs.element))
        {}
        ...
        map_impl(Pair&& element, T&&... rest)
          : rest_type(boost::forward<T>(rest)...)
          , element(boost::forward<Pair>(element))
        {}
        ...
        {
            rest_type::operator=(boost::forward<map_impl>(rhs));
            element = boost::forward<Pair>(rhs.element);
            return *this;
        }
